...
def get_model(args):
    if args.dataset == "ImageNet-LT" or args.dataset == "iNaturelist2018":
        ...
        net = Resnet_LT.resnext50_32x4d(num_classes=args.num_classes, args=args)
        return net
    else:
        ...
        if args.arch == 'resnet50':
            ...
            net = ResNet_cifar.resnet34(num_class=args.num_classes, args=args)
        return net
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fcc', type=float, default=0.0)
    parser.add_argument('--fcc_same', type=float, default=0.0)
    parser.add_argument('--fcc_half', type=float, default=0.0)
    main()
